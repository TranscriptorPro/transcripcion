...
/* Heading seguido de tabla: nunca quedar huérfano en borde de página */
.report-h2 + .report-table-block, .report-h3 + .report-table-block { break-before: avoid; page-break-before: avoid; }
