...
9. ESTUDIOS MULTI-ÓRGANO / MULTI-SEGMENTO: En estudios que evalúan múltiples órganos, segmentos anatómicos o vasos (ecografía, colonoscopía, gastroscopía, cinecoronariografía, Doppler vascular, etc.) dedica una sección ## separada a CADA estructura evaluada. Si una estructura fue evaluada con resultado normal, descíbe la normalidad en prosa (ej: "Tamaño y morfología conservados, sin lesiones focales."). Usa s/p Únicamente cuando la estructura NO fue mencionada ni evaluada en la transcripción. En la CONCLUSIÓN incluye SOLAMENTE los hallazgos patológicos o positivos, redactados en un párrafo fluido. No repitas descripciones de normalidad en la conclusión. No agregues recomendaciones ni interpretaciones que no estén explícitamente en la transcripción.` },
