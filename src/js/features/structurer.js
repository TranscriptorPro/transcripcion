...
10. ESTUDIOS MULTI-ÓRGANO / MULTI-SEGMENTO: En estudios que evalúan múltiples órganos, segmentos anatómicos o vasos (ecografía, colonoscopía, gastroscopía, cinecoronariografía, Doppler vascular, etc.) dedica una sección ## separada a CADA estructura evaluada. Si una estructura fue evaluada con resultado normal, descríbela en prosa (ej: "Tamaño y morfología conservados, sin lesiones focales."). Usa s/p ÚNICAMENTE cuando la estructura NO fue mencionada ni evaluada en la transcripción. En la CONCLUSIÓN: (a) menciona SOLO los hallazgos patológicos o positivos — no repitas normalidades; (b) puedes redactar una síntesis diagnóstica breve usando terminología médica estándar que se derive directamente de los hallazgos dictados (ej: "estenosis severa en DA compatible con enfermedad coronaria significativa"); (c) PROHIBIDO: inventar valores, porcentajes o datos que no estén en la transcripción; PROHIBIDO: indicar tratamientos, procedimientos o conductas concretas (stent, cirugía, medicación, derivación) si el médico no los mencionó explícitamente.` },
